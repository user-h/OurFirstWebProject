...
<body>
   ...
   <div class="main">
   		...
   		<form action="saveCla.do" method="post">
   			<input type="hidden" name="origincno" value="<%=clazz.getCno()%>" />
   			<span>班级号：</span> <input type="text" name="cno" value="<%=clazz.getCno() %>" /><br />
   			<span>班级名称：</span> <input type="text" name="lname" value="<%=clazz.getLname() %>"  /><br />
   			<span>学校名称：</span> <input type="text" name="school" value="<%=clazz.getSchool() %>"  /><br />
   			<span>专业：</span> <input type="text" name="professional" value="<%=clazz.getProfessional() %>"  /><br />
   			<span>班级人数：</span> <input type="number" name="num" value="<%=clazz.getNum() %>"  /><br />
